  ...
  return (
    <div className="mt-2">
      <div className="flex items-center justify-between mb-2">
        <span className="text-md text-orange-400">ChainId</span>
        <input
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-md text-orange-400">Token Address</span>
        <input
          className="w-[140px] py-2 px-4 border border-orange-400 text-md text-right font-semibold rounded-md"
      ...
      <div className="flex items-center justify-between mt-4">
        <span className="text-md text-orange-400">Required amount:</span>
      ...
      </div>
      {
        estimation?.srcChainTokenIn?.mutatedWithOperatingExpense && (
          <div className="flex items-center justify-between mt-4">
            <span className="text-md text-orange-400">Incl. gas expense:</span>
            <span className="text-md font-semibold">
              {
                isDeBridgeLoading ? (
                  <>Loading...</>
      ...
      <div className="flex items-center justify-between mt-4">
        <span className="text-md text-orange-400">Service fixed fee:</span>
        <span className="text-md font-semibold">
          {
            isDeBridgeLoading ? (
              <>Loading...</>
      ...
      <button
        className={cx('w-full py-3.5 text-white font-semibold text-center rounded-xl mt-6', {
          ...
          'bg-orange-300 cursor-not-allowed': isDisabled,
        })}
        disabled={isDisabled}
        onClick={submit}
      >
