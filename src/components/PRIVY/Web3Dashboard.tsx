  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="relative w-full max-w-7xl mx-auto">
        ...
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 z-10 bg-[#1e293b] text-white rounded-full p-2 hover:bg-[#334155] transition-colors"
        >
        ...
        <div className="min-h-[80vh] max-h-[90vh] overflow-y-auto bg-gradient-to-br from-[#0f172a] to-[#0a0e17] p-6 rounded-xl shadow-2xl">
