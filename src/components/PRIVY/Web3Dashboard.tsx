...
import WalletManagementColumn from './dashboard/WalletManagementColumn';
import WalletInformationColumn from './dashboard/WalletInformationColumn';
import TransactionsColumn from './dashboard/TransactionsColumn';
