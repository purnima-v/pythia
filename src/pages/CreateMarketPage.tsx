...
export default function CreateMarketPage() {
  ...
  const inputBorderColor = mode === 'pro' ? 'border-poseidon-border/60' : 'border-slate-300';
  ...
  const commonInputClass = `w-full p-2.5 rounded-md ${inputBgColor} ${textColor} border ${inputBorderColor} focus:outline-none focus:ring-2 ${inputFocusRingColor} transition-colors`;
  ...
  return (
    <div className={`p-4 sm:p-6 lg:p-8 ${bgColor} ${textColor} min-h-full font-serif`}>
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className={`p-6 sm:p-8 rounded-lg shadow-xl ${cardBgColor} border ${cardBorderColor} space-y-6`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select name="category" id="category" value={formState.category} onChange={handleInputChange} className={commonInputClass}>
          ...
          <div>
            ...
            <select name="marketType" id="marketType" value={formState.marketType} onChange={handleInputChange} className={commonInputClass}>
