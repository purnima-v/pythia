...
import { type GameQuery } from '@/types/Sport'
...
export function GameInfo(props: Props) {
  ...
  return (
    <div className="flex flex-col items-center pt-6 pb-8 bg-blue-500 rounded-[40px]">
      ...
      <div className="mt-5 grid grid-cols-[1fr_auto_1fr]">
        ...
        <div className="mx-5 pt-7 text-md text-orange-500">
