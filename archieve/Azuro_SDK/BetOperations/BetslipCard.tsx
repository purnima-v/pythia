...
//   return (
//     <div key={`${gameId}-${outcomeId}`} className="bg-orange-50 p-2 rounded-md mt-2 first-of-type:mt-0">
...
//               <div className="flex items-center justify-center w-8 h-8 p-1 mr-2 border border-orange-300 rounded-full">
//                 {
//                   Boolean(image) && (
...
//             </div>
//             <input
//               className="w-full py-2 px-4 border border-orange-400 text-md font-semibold rounded-md"
//               type="number"
