...
//       }
//       <div className="flex items-center justify-between">
//         <span className="text-md text-orange-400">Bet amount</span>
//         <input
...
//                   <span className="text-md text-orange-400">Batch Bet:</span>
...
//               isBatch ? (
//                 <div className="flex items-center justify-between mt-4">
//                   <span className="text-md text-orange-400">Total Bet Amount:</span>
//                   <span className="text-md font-semibold">{betAmount} {betToken.symbol}</span>
//                 </div>
//               ) : (
//                 <>
//                   <div className="flex items-center justify-between mt-4">
//                     <span className="text-md text-orange-400">Total Odds:</span>
//                     <span className="text-md font-semibold">
//                       {
//                         isOddsFetching ? (
//                           <>Loading...</>
...
//                   </div>
//                   <div className="flex items-center justify-between mt-4">
//                     <span className="text-md text-orange-400">Possible win:</span>
//                     <span className="text-md font-semibold">
//                       {
//                         isOddsFetching ? (
//                           <>Loading...</>
...
//                 <div className="flex items-center justify-between mt-4">
//                   <span className="text-md text-orange-400">Relayer fee:</span>
//                   <span className="text-md font-semibold">
//                     {
//                       isRelayerFeeLoading ? (
//                         <>Loading...</>
...
//                 <div className="flex items-center justify-between mt-4 border-t border-orange-300 pt-4">
